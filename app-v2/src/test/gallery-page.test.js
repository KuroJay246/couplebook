...
test('gallery route uses the read-only feature hook and archive view', async () => {
  ...
  assert.match(galleryViewSource, /Trusted media backend required/)
  assert.match(galleryViewSource, /will not open a Google OAuth popup for partner uploads/)
  ...
  assert.match(galleryViewSource, /Manage Media & Sync/)
  assert.match(galleryViewSource, /Album will not open a Google OAuth popup/)
  assert.match(galleryViewSource, /Shared media service/)
  assert.match(galleryViewSource, /Deployment approval required/)
